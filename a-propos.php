...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <a class="linksimg" href="../index.html">
                <img src="../IMG/logo.png" alt="Logo de Robbie Lens">
            </a>

            <ul class="nav-menu">
                <li><a href="../index.html">Accueil</a></li>
                <li id="nav-films"><a href="film.html" class="active">Films</a></li>
    ...
    <main class="about">
        ...
        <section>
            ...
            <div>
                ...
                <a class="radiant" href="./portfolio.html">VOIR MON PORTFOLIO</a>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            Retouches photo studio professionnel
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            Assistant photo lumière professionnel
                        </td>
    ...
    <footer>
        ...
        <a class="linksimg" href="../index.html"><img src="../IMG/logo.png" alt="Logo de Robbie Lens"></a>

        <div>

            <a class="linksimg" href="https://twitter.com/" target="_blank">
                <img src="../IMG/twitter.png" alt="Logo Twitter">
            </a>
            <a class="linksimg" href="https://www.instagram.com/" target="_blank">
